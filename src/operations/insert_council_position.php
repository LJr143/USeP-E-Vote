<?php
    ...
    $statusMsg = '';
    $success = '';
    $position= filter_var($_POST['councilPosition'],FILTER_SANITIZE_STRING);
    ...
    $action = "Added student council position "."\"".$position."\"";
    $dt = date('Y-m-d G:i:s');
...
if ($row) {
    ...
    $query = "INSERT into tbcouncil (campus,position_name,code) VALUES('$campus', '$position','$code')";
