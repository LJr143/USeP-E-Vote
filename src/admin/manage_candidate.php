      ...
      <div id="content-wrapper">
        ...
        <div class="card-body">
          <form  id="addNomineeForm" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
            <div class="col-md-12">
             <select id="party" name="party"  class="custom-select" id="inputGroupSelect04">
             ...
             <span id = "errorParty"style ="color:red;"></span>
            </div>
            </div>
            ...
            <div class="form-row">
            <div class="col-md-12">
             <select id="indicator" name="indicator" class="custom-select" id="inputGroupSelect04">
             ...
             <span id = "errorIndicators"style ="color:red;"></span>
            </div>
            </div>
