          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="card mb-3 shadow p-3 mb-5 bg-white rounded">
                ...
                <div class="card-footer small text-muted">Pie Chart shows the distribution of data between the total number of voters who vote and total number of voters who did not vote</div>
              </div>
            </div>
          </div>
          </div>
