...
<html lang="en">  
  ...
  <style>
    ...
    @media (max-width:767px)
    {
      ...
      #mabininominees_filterSelect3,#tagumnominees_filterSelect3,
      #localmabininominees_filterSelect2,#localtagumnominees_filterSelect2,
      #localmabininominees_filterSelect3,#localtagumnominees_filterSelect3,
      #localmabininominees_filterSelect4,#localtagumnominees_filterSelect4{
        max-width:50% !important; 
      }
      #mabininominees_filterWrapper,#tagumnominees_filterWrapper,
      #localmabininominees_filterWrapper,#localtagumnominees_filterWrapper{
                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs nav-fill card-body bg-success" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-mabini-tab" data-toggle="tab" href="#nav-mabini" role="tab" aria-controls="nav-mabini" aria-selected="false">Mabini Campus</a>
                        ...
                        <div class="tab-content text-white" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-mabini" role="tabpanel" aria-labelledby="nav-mabini-tab">
                            <br>
